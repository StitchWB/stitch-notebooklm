...
Spawns ``python -m stitch_notebooklm`` (no host dependency) and walks the
JSON-RPC 2.0 line protocol: init → _migrate_db → ping → list_notebooks → shutdown.
...
MODULE = "stitch_notebooklm"
PLUGIN_ID = "stitch-notebooklm"
TEST_COMMAND = "list_notebooks"
